...
contract SharedAssets {
    ...
    struct Asset {
        ...
        string name;
        uint cost;
        // Important to have this payable so that we can refund the ether
    ...
    function donate() payable public{
        // Send the contract money just to be nice
    }
    ...
    constructor() public {
        ...
        addAsset("Food Processor", 0.5 ether);
        addAsset("Luggage", 5 ether);
        addAsset("Inflatable Matress", 2 ether);
        addAsset("Tent", 10 ether);
        addAsset("35L Hiking Pack", 10 ether);
    }
